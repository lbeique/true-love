...
const getUserByLogin = async (postBody) => {
    ...
    const sqlSelectUserByEmail = "SELECT user.user_id, avatar.avatar_name, user.user_name, user.password_hash FROM user JOIN avatar ON avatar.avatar_id = user.avatar_id WHERE user_name = :identifier;"

...
function analytics(room, firstLeaderboard, secondLeaderboard) {
    let dialogue = []
    let players = room.clients
    if (!secondLeaderboard) {
        if (firstLeaderboard[0].points > 0 && firstLeaderboard[0].points !== firstLeaderboard[1]?.points) {
        ...
        if (howCloseIsGame <= 5) {
            if (howCloseIsGame === 0) {
                ...
                dialogue.push(`What a close game! ${firstLeaderboard[0].username} is only ${howCloseIsGame} points ahead of ${firstLeaderboard[1].username}!`)
            }
        }
        ...
        if (howCloseIsGame <= 5) {
            if (howCloseIsGame === 0) {
                ...
                dialogue.push(`After two rounds, ${secondLeaderboard[0].username} and ${secondLeaderboard[1].username} are only ${howCloseIsGame} points apart!`)
            }
        }
